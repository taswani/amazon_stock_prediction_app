...
In order to start the application `pip3 install -r requirements.txt` and `flask run --without-threads` in your terminal or command prompt. After that, create an account and enter your queries!
